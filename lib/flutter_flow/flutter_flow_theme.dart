...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFE9E9E9);
  Color secondaryColor = const Color(0xFFFFFFFF);
  Color tertiaryColor = const Color(0xFFF54748);
  Color alternate = const Color(0xFF000000);
  Color primaryBackground = const Color(0xFFE9E9E9);
  Color secondaryBackground = const Color(0xFFFFFFFF);
  Color primaryText = const Color(0xFF000000);
  Color secondaryText = const Color(0xFFF54748);
